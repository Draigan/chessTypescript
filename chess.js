...
"abcdefgh".split('').forEach(function (letter) {
    "12345678".split('').forEach(function (number) {
        divArray.push(_this["".concat(letter).concat(number, "div")] = document.querySelector(".".concat(letter).concat(number, "-Square")));
    });
});
//c
//  Squares Class
var Square = /** @class */ (function () {
    function Square(_rowParam, _colParam, _typeParam, _colorParam) {
...
//  Making Squares
var squaresArray = [];
var a1Square = new Square(0, 0, 'rook', 'white');
var a2Square = new Square(1, 0, 'pawn', 'white');
var a3Square = new Square(2, 0, '', '');
var a4Square = new Square(3, 0, '', '');
var a5Square = new Square(4, 0, '', '');
var a6Square = new Square(5, 0, '', '');
var a7Square = new Square(6, 0, 'pawn', 'black');
var a8Square = new Square(7, 0, 'rook', 'black');
var b1Square = new Square(0, 1, 'knight', 'white');
var b2Square = new Square(1, 1, 'pawn', 'white');
var b3Square = new Square(2, 1, '', '');
var b4Square = new Square(3, 1, '', '');
var b5Square = new Square(4, 1, '', '');
var b6Square = new Square(5, 1, '', '');
var b7Square = new Square(6, 1, 'pawn', 'black');
var b8Square = new Square(7, 1, 'knight', 'black');
var c1Square = new Square(0, 2, 'bishop', 'white');
var c2Square = new Square(1, 2, 'pawn', 'white');
var c3Square = new Square(2, 2, '', '');
var c4Square = new Square(3, 2, '', '');
var c5Square = new Square(4, 2, '', '');
var c6Square = new Square(5, 2, '', '');
var c7Square = new Square(6, 2, 'pawn', 'black');
var c8Square = new Square(7, 2, 'bishop', 'black');
var d1Square = new Square(0, 3, 'queen', 'white');
var d2Square = new Square(1, 3, 'pawn', 'white');
var d3Square = new Square(2, 3, '', '');
var d4Square = new Square(3, 3, '', '');
var d5Square = new Square(4, 3, '', '');
var d6Square = new Square(5, 3, '', '');
var d7Square = new Square(6, 3, 'pawn', 'black');
var d8Square = new Square(7, 3, 'queen', 'black');
var e1Square = new Square(0, 4, 'king', 'white');
var e2Square = new Square(1, 4, 'pawn', 'white');
var e3Square = new Square(2, 4, '', '');
var e4Square = new Square(3, 4, '', '');
var e5Square = new Square(4, 4, '', '');
var e6Square = new Square(5, 4, '', '');
var e7Square = new Square(6, 4, 'pawn', 'black');
var e8Square = new Square(7, 4, 'king', 'black');
var f1Square = new Square(0, 5, 'bishop', 'white');
var f2Square = new Square(1, 5, 'pawn', 'white');
var f3Square = new Square(2, 5, '', '');
var f4Square = new Square(3, 5, '', '');
var f5Square = new Square(4, 5, '', '');
var f6Square = new Square(5, 5, '', '');
var f7Square = new Square(6, 5, 'pawn', 'black');
var f8Square = new Square(7, 5, 'bishop', 'black');
var g1Square = new Square(0, 6, 'knight', 'white');
var g2Square = new Square(1, 6, 'pawn', 'white');
var g3Square = new Square(2, 6, '', '');
var g4Square = new Square(3, 6, '', '');
var g5Square = new Square(4, 6, '', '');
var g6Square = new Square(5, 6, '', '');
var g7Square = new Square(6, 6, 'pawn', 'black');
var g8Square = new Square(7, 6, 'knight', 'black');
var h1Square = new Square(0, 7, 'rook', 'white');
var h2Square = new Square(1, 7, 'pawn', 'white');
var h3Square = new Square(2, 7, '', '');
var h4Square = new Square(3, 7, '', '');
var h5Square = new Square(4, 7, '', '');
var h6Square = new Square(5, 7, '', '');
var h7Square = new Square(6, 7, 'pawn', 'black');
var h8Square = new Square(7, 7, 'rook', 'black');
var benPassantArray = [a3Square, b3Square, c3Square, d3Square, e3Square, f3Square, g3Square, h3Square];
var wenPassantArray = [a6Square, b6Square, c6Square, d6Square, e6Square, f6Square, g6Square, h6Square];
function findKing(color) {
    if (squaresArray.find(function (square) { return square.pieceType == 'king' && square.pieceColor == color; }) != null) {
        return squaresArray.find(function (square) { return square.pieceType == 'king' && square.pieceColor == color; });
    }
}
;
function pastBoardUpdate() {
...
function updateRealWithPastBoard() {
    for (var i = 0; i < squaresArray.length; i++) {
...
function CheckForPin() {
    var whiteKingSquare = findKing('white');
    var blackKingSquare = findKing('black');
    resetCount();
    altSnapshot();
    countChecker();
    if (blackKingSquare != null && whiteKingSquare != null) {
...
function turnColorSwitcher() { currentTurnColor = currentTurnColor == 'white' ? 'black' : 'white'; }
function changeTurn() {
    if (false == CheckForPin()) {
        return;
    }
    turnColorSwitcher();
...
function resetPossibleAndEncounter() {
    for (var i = 0; i < squaresArray.length; i++) {
...
function visualizePossibilities() {
    for (var i = 0; i < squaresArray.length; i++) {
        ...
        if (squaresArray[i].possible == true) {
            divArray[i].classList.add("possible");
        }
    }
}
function unvisualizePossibilities() {
    for (var i = 0; i < squaresArray.length; i++) {
        if (squaresArray[i].encounter == false) {
            divArray[i].classList.remove("encounter");
        }
        if (squaresArray[i].possible == false) {
            divArray[i].classList.remove("possible");
        }
        if (squaresArray[i].enPassant == false) {
            divArray[i].classList.remove("enpassant");
        }
    }
}
...
function mapImages() {
    ...
    for (var i = 0; i < squaresArray.length; i++) {
        ...
        divArray[i].innerHTML =
            "<img src=\"./".concat(pieceSet, "/").concat(colorMap[squaresArray[i].pieceColor]).concat(pieceMap[squaresArray[i].pieceType], ".").concat(fileTypeMap[pieceSet], "\">  ");
    }
}
mapImages();
function changePieceButton() {
    if (pieceSet == 'basic') {
        pieceSet = 'anarcandy';
        return mapImages();
    }
...
function checkSquaresAroundKing() {
    var _a, _b;
    var color = currentTurnColor;
    var row = (_a = findKing(color)) === null || _a === void 0 ? void 0 : _a.row;
    var col = (_b = findKing(color)) === null || _b === void 0 ? void 0 : _b.col;
    if (row && col) {
        var arr = [[row + 1, col], [row + 1, col + 1], [row, col + 1], [row - 1, col + 1],
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            var square = findSquare(arr[i][0], arr[i][1]);
            console.log(square);
            var count = color == "white" ? square === null || square === void 0 ? void 0 : square.blackCount : square === null || square === void 0 ? void 0 : square.whiteCount;
            if (count == 0 && (square === null || square === void 0 ? void 0 : square.pieceColor) == '') {
                console.log(i + "free square");
                return true;
            }
            if (count == 0 && (square === null || square === void 0 ? void 0 : square.pieceColor) != currentTurnColor) {
...
function recursionCallbackForMovement(row, col, direction, callBack) {
    if (direction == 'stop' || "pawnUp" == direction) {
        return;
    }
    if (direction == 'up') {
...
function movement(row, col, myCallback, piece, option) {
    var arr = [[0, 0, "string"]];
    switch (piece) {
        case "rook":
...
function mateChecker() {
    ...
    for (var i = 0; i < squaresArray.length; i++) {
        if (squaresArray[i].pieceType == 'rook' && squaresArray[i].pieceColor == currentTurnColor) {
            if (findSquare(squaresArray[i].row, squaresArray[i].col) != undefined) {
    ...
    var checkMateElement = document.getElementById('checkmate-id');
    if (checkMateElement) {
        if (true == checkMate) {
            return checkMateElement.innerHTML = 'CHECKMATE!!!!!!';
        }
        else {
...
function mateDirection(row, col, direction, startSquare) {
    var _a, _b, _c;
    ...
    /*  if ("pawnUp" == direction && findSquare(row+1,col).altPieceType != "" && currentTurnColor == "white")
     {return}
     if ("pawnUp" == direction && findSquare(row-1,col).altPieceType != "" && currentTurnColor == "black")
     {return} */
    // ran into a piece of the same color
    if (((_a = findSquare(row, col)) === null || _a === void 0 ? void 0 : _a.pieceColor) == currentTurnColor) {
        return;
    }
    // ran into a piece of opposite color
    if (((_b = findSquare(row, col)) === null || _b === void 0 ? void 0 : _b.pieceColor) != currentTurnColor && ((_c = findSquare(row, col)) === null || _c === void 0 ? void 0 : _c.pieceColor) != '') {
        ...
        if (0 == findKing('black').whiteCount && currentTurnColor == 'black') {
            checkMate = false;
        }
        if (0 == findKing('white').blackCount && currentTurnColor == 'white') {
            checkMate = false;
        }
        altSnapshot();
        return;
...
function matePawn(row, col, forward) {
    if (findSquare(row, col) == undefined) {
        return;
    }
...
function countDirection(row, col, direction) {
    if (findSquare(row, col) == undefined) {
        return;
    }
...
function pieceChecker(clickedSquare, row, col) {
    ...
    if ('pawn' == clickedSquare.pieceType && clickedSquare.pieceColor == "black") {
        var pawnArray = [a7Square, b7Square, c7Square, d7Square, e7Square, f7Square, g7Square, h7Square];
        var currentSquare = findSquare(row, col);
        if (currentSquare == b4Square || currentSquare == c4Square || currentSquare == d4Square || currentSquare == e4Square
            || currentSquare == f4Square || currentSquare == g4Square || currentSquare == h4Square) {
            bEnPassantLeft(row, col);
        }
        if (currentSquare == b4Square || currentSquare == c4Square || currentSquare == d4Square || currentSquare == e4Square
            || currentSquare == f4Square || currentSquare == g4Square || currentSquare == a4Square) {
    ...
    if ('pawn' == clickedSquare.pieceType && clickedSquare.pieceColor == "white") {
        var wPawnArray = [a2Square, b2Square, c2Square, d2Square, e2Square, f2Square, g2Square, h2Square];
        var currentSquare = findSquare(row, col);
        if (currentSquare == b5Square || currentSquare == c5Square || currentSquare == d5Square || currentSquare == e5Square
            || currentSquare == f5Square || currentSquare == g5Square || currentSquare == h5Square) {
            wEnPassantLeft(row, col);
        }
        if (currentSquare == b5Square || currentSquare == c5Square || currentSquare == d5Square || currentSquare == e5Square
            || currentSquare == f5Square || currentSquare == g5Square || currentSquare == a5Square) {
            wEnPassantRight(row, col);
        }
        for (var i = 0; i < wPawnArray.length; i++) {
...
//
function pieceDirection(row, col, direction) {
    if (findSquare(row, col) == undefined) {
        return;
    }
    ...
    if (findSquare(row, col).pieceColor != '' && findSquare(row, col).pieceColor != currentTurnColor) {
        ...
        if ("black" == currentTurnColor && direction == "pawnUp" && findSquare(row - 1, col) != "") {
            return;
        }
        if ("white" == currentTurnColor && direction == "pawnUp" && findSquare(row + 1, col) != "") {
            return;
        }
...
function pawnEncounter(row, col) {
    var currentSquare = findSquare(row, col);
    if (currentSquare == undefined) {
        return;
    }
...
function wEnPassantRight(row, col) {
    rightOfPawn = findSquare(row, col + 1);
    rightStartingSquare = findSquare(row + 2, col + 1);
    rightFindTradeSquare = findSquare(row + 1, col + 1);
    var wEnPassantArray = [a5Square, b5Square, c5Square, d5Square, e5Square, f5Square, g5Square];
    for (var i = 0; i < wEnPassantArray.length; i++) {
        if (wEnPassantArray[i].pieceType == 'pawn' && wEnPassantArray[i].pieceColor == 'white'
            && currentTurnColor == 'white' && rightOfPawn.pieceType == 'pawn'
            && rightOfPawn.pieceColor == 'black' && lastObject == rightStartingSquare) {
            console.log('enPassant');
...
function bEnPassantLeft(row, col) {
    leftOfPawn = findSquare(row, col - 1);
    leftStartingSquare = findSquare(row - 2, col - 1);
    leftFindTradeSquare = findSquare(row - 1, col - 1);
    var bEnPassantArray = [b4Square, c4Square, d4Square, e4Square, f4Square, g4Square, h4Square];
    for (var i = 0; i < bEnPassantArray.length; i++) {
        if (bEnPassantArray[i].pieceType == 'pawn' && bEnPassantArray[i].pieceColor == 'black'
            && currentTurnColor == 'black' && leftOfPawn.pieceType == 'pawn'
            && leftOfPawn.pieceColor == 'white' && lastObject == leftStartingSquare) {
            console.log('enPassant');
            leftTradeSquare = leftFindTradeSquare;
            leftTradeSquare.enPassant = true;
        }
...
function bEnPassantRight(row, col) {
    rightOfPawn = findSquare(row, col + 1);
    rightStartingSquare = findSquare(row - 2, col + 1);
    rightFindTradeSquare = findSquare(row - 1, col + 1);
    var bEnPassantArray = [a4Square, b4Square, c4Square, d4Square, e4Square, f4Square, g4Square];
    for (var i = 0; i < bEnPassantArray.length; i++) {
        if (bEnPassantArray[i].pieceType == 'pawn' && bEnPassantArray[i].pieceColor == 'black'
            && currentTurnColor == 'black' && rightOfPawn.pieceType == 'pawn'
            && rightOfPawn.pieceColor == 'white' && lastObject == rightStartingSquare) {
            console.log('enPassant');
            rightTradeSquare = rightFindTradeSquare;
            rightTradeSquare.enPassant = true;
        }
...
function enPassantMove(row, col, color_direction) {
...
var _loop_1 = function (index) {
    ...
    divArray[index].addEventListener('click', function () { mainEventFunction(squaresArray[index]); });
};
for (var index = 0; index < divArray.length; index++) {
    _loop_1(index);
}
function mainEventFunction(currentSquare) {
